...
| [#178](https://github.com/aws-solutions-library-samples/guidance-for-aws-deepracer-event-management/pull/178) | feat(models): drag and drop model upload using CloudScape FileUpload | None (single component swap) — closes #38 | ✅ Rebased on v3.0.4 2026-05-02 (`1d4b019`) — clean fast-forward |
| [#179](https://github.com/aws-solutions-library-samples/guidance-for-aws-deepracer-event-management/pull/179) | feat: dark mode and compact density toggle | None (topNav + CSS only) — closes #36 | ✅ Rebased on v3.0.4 2026-05-02 (`8df760d`) — clean fast-forward |
...
| [#195](https://github.com/aws-solutions-library-samples/guidance-for-aws-deepracer-event-management/pull/195) | fix(leaderboard): handle null trackId in getLeaderboard resolver (closes #194) | None (Lambda-only fix) | ✅ Rebased on v3.0.4 2026-05-02 (`01c22fa`) — clean fast-forward |
